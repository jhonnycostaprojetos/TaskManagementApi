...
namespace TaskManagement.Infra.Data.Migrations
{
    ...
    [Migration("20240305221214_AddnewFieldsForLog")]
    partial class AddnewFieldsForLog
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TaskManagement.Domain.Entities.Project", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateAt = new DateTime(2024, 3, 5, 22, 12, 14, 292, DateTimeKind.Utc).AddTicks(215),
                            ProjectName = "Projeto",
                            UserId = 1
                        });
                });
            ...
            modelBuilder.Entity("TaskManagement.Domain.Entities.TaskProject", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateAt = new DateTime(2024, 3, 5, 22, 12, 14, 292, DateTimeKind.Utc).AddTicks(2381),
                            Description = "Descrição",
                            DueDate = new DateTime(2024, 3, 5, 19, 12, 14, 292, DateTimeKind.Local).AddTicks(2343),
                            ProjectId = 1,
                            Title = "Projeto"
                        });
                });
            ...
            modelBuilder.Entity("TaskManagement.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateAt = new DateTime(2024, 3, 5, 22, 12, 14, 292, DateTimeKind.Utc).AddTicks(3981),
