...
namespace TaskManagement.Infra.Data.Migrations
{
    ...
    [Migration("20240305033645_addComment")]
            ...
            modelBuilder.Entity("TaskManagement.Domain.Entities.Project", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateAt = new DateTime(2024, 3, 5, 3, 36, 45, 233, DateTimeKind.Utc).AddTicks(9951),
                            ProjectName = "Projeto",
                            UserId = 1
                        });
                });
            ...
            modelBuilder.Entity("TaskManagement.Domain.Entities.TaskProject", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateAt = new DateTime(2024, 3, 5, 3, 36, 45, 234, DateTimeKind.Utc).AddTicks(6682),
                            Description = "Descrição",
                            DueDate = new DateTime(2024, 3, 5, 0, 36, 45, 234, DateTimeKind.Local).AddTicks(6594),
                            Priority = 0,
                            ProjectId = 1,
                            Status = 0,
                            Title = "Projeto"
            ...
            modelBuilder.Entity("TaskManagement.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateAt = new DateTime(2024, 3, 5, 3, 36, 45, 235, DateTimeKind.Utc).AddTicks(2189),
